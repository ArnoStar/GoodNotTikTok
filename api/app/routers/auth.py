...
def login(user:User = Depends(verify_credentials)):
    ...
    return {"access_token": token, "token_type": "bearer"} # I need to create a refresh token system, yes, this is a really cool comment, this comment will be really long
