...
def login(user:User = Depends(verify_credentials)):
    ...
    return {"access_token": token, "token_type": "bearer"} #This time I even have hope that will work I need to create a refresh token system, yes, this is a really cool comment, this comment will be really long, i want to fucking kill my self
